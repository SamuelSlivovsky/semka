...
create or replace procedure generovanie_operacia_lekar_p --procedure na vygenerovanie dat tabulky operacia_lekar tak aby lekar bol zo spravneho oddelenia
as

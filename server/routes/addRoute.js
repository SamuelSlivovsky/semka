...
router.post('/recept', verify.verifyRoles(0, 2,3), controller.insertRecept);
router.post('/priloha', verify.verifyRoles(0, 2,3), controller.insertPriloha);
router.post(
  '/vysetrenie',
  verify.verifyRoles(0, 2,3),
  controller.insertVysetrenie
);
router.post('/operacia', verify.verifyRoles(0, 2,3), controller.insertOperacia);
router.post(
  '/hospitalizacia',
  verify.verifyRoles(0, 2,3),

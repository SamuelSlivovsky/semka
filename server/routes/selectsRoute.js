...
router.get("/najviacOperovanyPercenta/:percent", controller.getNajviacOperovanyPercenta); //12
router.get("/najviacHospitalizovaniPercenta/:percent", controller.getNajviacHospitalizovaniPercenta); //13
router.get("/topZamestnanciVyplaty/:pocet", controller.getTopZamestnanciVyplatyPocet); //14
...
router.get("/operacieNemocniceXML/:id_nemocnice", controller.getOperacieNemocniceXML);
router.get("/ockovaniaNemocniceXML/:id_nemocnice", controller.getOckovaniaNemocniceXML);
router.get("/vysetreniaNemocniceXML/:id_nemocnice", controller.getVysetreniaNemocniceXML);


router.get("/zamestnanciOddelenia/:id_oddelenia", controller.getZamestnanciOddelenia);
router.get("/pocetZamOddelenia/:id_oddelenia/:rok", controller.getPocetZamOddelenia);
router.get("/pocetPacOddelenia/:id_oddelenia", controller.getPocetPacientovOddelenia);
router.get("/pocetOperOddelenia/:id_oddelenia/:rok", controller.getPocetOperaciiOddelenia);
router.get("/pocetHospitOddelenia/:id_oddelenia/:rok", controller.getPocetHospitalizaciiOddelenia);
router.get("/pocetVyseOddelenia/:id_oddelenia/:rok", controller.getPocetVysetreniOddelenia);
...
router.get("/topZamestnanciVyplatyOddelenie/:id_oddelenia/:rok", controller.getTopZamestnanciVyplatyOddelenie);

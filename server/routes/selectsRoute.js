...
router.get(
  "/pocetPacOddelenia/:cislo_zam/:rok",
  verify.verifyRoles(0, 1, 2, 3),
...
router.get(
  "/krvneSkupinyOddelenia/:cislo_zam/:rok",
  verify.verifyRoles(0, 1, 2, 3),
  controller.getKrvneSkupinyOddelenia
);
router.get(
  "/pomerMuziZeny/:cislo_zam/:rok",
  verify.verifyRoles(0, 1, 2, 3),
  controller.getPomerMuziZeny
);
router.get(
  "/pocetPacientiPodlaVeku/:cislo_zam/:rok",
  verify.verifyRoles(1, 2, 3),
...
router.get(
  "/udalostiOddelenia/:cislo_zam/:rok",
  verify.verifyRoles(0, 3),
  controller.getUdalostiOddelenia
);

...
const medicamentsRoute = require("./routes/medicamentsRoute");
const medicalAidsRoute = require("./routes/medicalAidsRoute");
...
app.use("/medicaments", medicamentsRoute);
app.use("/medicalAids", medicalAidsRoute);
